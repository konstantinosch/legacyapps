...
#else//#define __SHAWN_LEGACYAPPS_MODULE_UNIGE_WISELIB_PLTT_PROCESSOR_H
...
#define PLTT_MAX_NEIGHBORS_SUPPORTED 500
#define PLTT_MAX_TARGETS_SUPPORTED 200
#define PLTT_MAX_PRIVACY_MESSAGES_SUPPORTED 1000
...
typedef wiselib::PLTT_TrackerType<Os, PLTT_Agent, Node, Position, IntensityNumber, Timer, Radio, ReliableRadio, Rand, Clock, Debug> PLTT_Tracker;
	...
	private:
		...
		millis_t target_init_spread_milis;
		...
		int nb_convergence_time_max_counter;
		int nb_connections_high;
		int nb_connections_low;
