...
namespace shawn
{
    ...
    /// The CustomTransmissionModel delivers every message without loss."
    ...
    */
    ...
    public:
        ...
        CustomTransmissionModel(bool = false);
        virtual ~CustomTransmissionModel();
...
#endif
/*-----------------------------------------------------------------------
* Source  $Source: /cvs/shawn/shawn/sys/transm_models/custom_transmission_model.h,v $
* Version $Revision: 504 $
* Date    $Date: 2011-01-24 20:00:04 +0100 (Mon, 24 Jan 2011) $
*-----------------------------------------------------------------------
* $Log: custom_transmission_model.h,v $
 *-----------------------------------------------------------------------*/
